...
<p>
    ...
    <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php $totalw = ($pekerjaan['wc_xtranslated'] * $pekerjaan['w_xtranslated']) + ( $pekerjaan['wc_repetition'] * $pekerjaan['w_repetition']) + ($pekerjaan['wc_fuzzy100'] * $pekerjaan['w_fuzzy100']) 
                        + ($pekerjaan['wc_fuzzy95'] * $pekerjaan['w_fuzzy95']) + ($pekerjaan['wc_fuzzy85'] * $pekerjaan['w_fuzzy85']) 
                        + ($pekerjaan['wc_fuzzy75'] * $pekerjaan['w_fuzzy75']) + ($pekerjaan['wc_fuzzy50'] * $pekerjaan['w_fuzzy50']) + ($pekerjaan['wc_nomatch'] * $pekerjaan['w_nomatch']) / 100?>
                    <tr>
                        <th>Total</th>
