...
if (isset($_POST['submit'])) {
 ...
 if (!empty($bln)&&!empty($thun)) {
  ...
  $q = mysqli_query($conn, "SELECT * FROM pekerjaan WHERE MONTH(tgl_dibuat) = '$bln' and year(tgl_dibuat) = '$thun' and id_pm ='".$user['id']."'");
 } else {
  // perintah tampil semua data
  $q = mysqli_query($conn, "SELECT * FROM pekerjaan p where id_pm ='".$user['id']."'");
 }
} else {
 // perintah tampil semua data
 $q = mysqli_query($conn, "SELECT * FROM pekerjaan where id_pm ='".$user['id']."'");
}
